...
public class WeldVertex
{
    ...
    public WeldVertex(Vector3 aPos)
    {
        pos = aPos;
    }
}
...
public class MeshWelder
{
    ...
    private bool Compare(WeldVertex v1, WeldVertex v2)
    {
    ...
    private void CreateVertexList()
    {
        ...
        vertices = new WeldVertex[Positions.Length];
        for (int i = 0; i < Positions.Length; i++)
        {
            var v = new WeldVertex(Positions[i]);
